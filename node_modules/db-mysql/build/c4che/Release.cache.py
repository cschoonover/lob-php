...
LIBDIR = '/usr/libexec/openshift/cartridges/c9-0.1/root/lib-0.10/node_modules'
LIBPATH_NODE = '/usr/lib'
LIBPATH_ST = '-L%s'
LIB_MYSQLCLIENT_R = ['mysqlclient_r']
LIB_ST = '-l%s'
LINKFLAGS = ['-rdynamic', '-L/usr/lib64/mysql', '-lmysqlclient_r', '-lz', '-lpthread', '-lcrypt', '-lnsl', '-lm', '-lssl', '-lcrypto']
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CXX = ['/usr/bin/g++']
MYSQL_CONFIG = '/usr/bin/mysql_config'
NODE_PATH = '/usr/libexec/openshift/cartridges/c9-0.1/root/lib-0.10/node_modules'
PREFIX = '/usr/local'
PREFIX_NODE = '/usr'
